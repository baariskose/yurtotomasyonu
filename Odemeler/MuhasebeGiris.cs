...
namespace YurtOtomasyonu2.Odemeler
{
    ...
    public partial class MuhasebeGiris : Form
    {
        ...
        private void tbxMudToptutar_TextChanged(object sender, EventArgs e)
        {

        }

        private void cbMudurMaasOdendiMi_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void btnMudGeri_Click(object sender, EventArgs e)
        {
        ...
        private void btnGorGeri_Click(object sender, EventArgs e)
        {
            Anagiris anagiris = new Anagiris();
            anagiris.ShowDialog();
            this.Hide();
        ...
        private void btnGeriMuh_Click(object sender, EventArgs e)
        {
            Anagiris anagiris = new Anagiris();
            anagiris.ShowDialog();
            this.Hide();
        ...
        private void btnMudGeri_Click_1(object sender, EventArgs e)
        {
            Anagiris anagiris = new Anagiris();
            this.Close();
            anagiris.Show();
